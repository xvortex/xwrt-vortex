...
function show_banner(L3){// L3 = The third Level of Menu
	...
	if (spirit_logo_support)
		...
		banner_code +='<div style="margin-left:25px;width:160px;height:54px;margin-top:0px;float:left;" align="left"><span><a href="http://xvtx.ru/xwrt/" target="_blank"><img src="images/merlin-logo.png" style="border: 0;"></span></div>';
	}
	// logout, reboot
...
tabtitle[16] = new Array("", "Sysinfo", "Other Settings", "Run Cmd");
...
tablink[16] = new Array("", "Tools_Sysinfo.asp", "Tools_OtherSettings.asp", "Tools_RunCmd.asp");
...
function show_footer(){
	...
	var model_name_supportsite = "RTAC68U";
