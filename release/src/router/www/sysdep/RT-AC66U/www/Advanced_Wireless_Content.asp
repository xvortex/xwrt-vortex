...
function initial(){
	...
	if(band5g_support && band5g_11ac_support && document.form.wl_unit[1].selected == true){ //AC 5G
		...
		else if(based_modelid == "DSL-AC68U" || based_modelid == "RT-AC68U" || based_modelid == "EA6900" || based_modelid == "R7000" || based_modelid == "WS880" || based_modelid == "RT-AC68A" || based_modelid == "4G-AC68U" ||
	...
	if(is_UA_sku && !Qcawifi_support && !Rawifi_support && !sdk_5){
		...
		if(based_modelid == "RT-AC68U" || based_modelid == "EA6900" || based_modelid == "R7000" || based_modelid == "WS880" || based_modelid == "RT-AC68A" || based_modelid == "4G-AC68U" || based_modelid == "DSL-AC68U"
