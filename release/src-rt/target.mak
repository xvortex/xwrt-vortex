...
export VTX_BASE6 := $(filter-out RTAC68U=y JFFS2LOG=y DUMP_OOPS_MSG=y TURBO=y LOGO_LED=y LINUX_MTD="64",$(RT-AC68U_BASE))
export VTX_BASE6 += XWRT=y JFFS2LOG=n LINUX_MTD="32" XHCIMODE=y TCODE=n
